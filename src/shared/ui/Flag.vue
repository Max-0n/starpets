...
// import.meta.glob возвращает ключи в формате '/shared/assets/flags/name.svg'
const flags = import.meta.glob('~/shared/assets/flags/*.svg', { eager: false }) as ComponentImport
const FlagComponent = shallowRef<Component | null>(null)
const flagUrl = computed(() => {
  if (!props.code) return null
  return `/shared/assets/flags/${props.code.toLowerCase()}.svg`
})
...
watch(
  ...
  async code => {
    ...
    // Правильный формат ключа: '/shared/assets/flags/name.svg'
    const path = `/shared/assets/flags/${code.toLowerCase()}.svg`
